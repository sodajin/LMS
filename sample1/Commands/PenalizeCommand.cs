...
namespace LibraryManagementSystem.Commands
{
    public class PenalizeCommand : CommandBase
    {
        ...
        public PenalizeCommand(ManageMembersViewModel viewModel, UserList userList, int index, NavigationStore dashboardNavigationStore, Func<ViewModelBase> createManageMembersViewModel) 
        {
        ...
        public override void Execute(object parameter)
        {
            ...
            User user = _userList.GetUserFromElement(_index);
            if (_userList.GetReputation(_index) <= 0)
            {
            ...
            _userList.GetUserFromElement(_index).AddReputation(-20);
            _dashboardNavigationStore.CurrentViewModel = _createManageMembersViewModel();
        }
    }
}
